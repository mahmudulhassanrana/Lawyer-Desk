                                    ...
                                    @if($casedairy->file_1)
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <img src="{{asset('storage/'.$casedairy->file_1)}}" class="img-thumbnail">
                                    ...
                                    @if($casedairy->file_2)
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <img src="{{asset('storage/'.$casedairy->file_2)}}" class="img-thumbnail">
                                    ...
                                    @if($casedairy->file_3)
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <img src="{{asset('storage/'.$casedairy->file_3)}}" class="img-thumbnail">
                            ...
                            <dev class="row">
                                <div class="col-6">
                                    @if($casedairy->file_4)
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <img src="{{asset('storage/'.$casedairy->file_4)}}" class="img-thumbnail">
                                            </div>
                                        </div>
                                    @endif
