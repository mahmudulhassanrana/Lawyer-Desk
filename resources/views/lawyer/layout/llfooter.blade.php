                    ...
                    <li class="has-sub active expand">
                        ...
                        <ul class="collapse show" id="dashboard"
                            ...
                            <div class="sub-menu">
                                ...
                                <li  class="has-sub" >
                                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#components"
                                       aria-expanded="false" aria-controls="components">
                                        <span class="nav-text">Case Diary </span> <b class="caret"></b>
                                    </a>
                                    <ul  class="collapse"  id="components">
                                        <div class="sub-menu">

                                            <li >
                                                <a href="{{url('/dairy')}}">Create Case Diary </a>
                                            </li>

                                            <li >
                                                <a href="{{url('/casedairy')}}">Active Case Diary</a>
                                            </li>

                                            <li >
                                                <a href="{{url('/dismissedlist')}}">Dissmiss Case Diary</a>
                                            </li>
                                        </div>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <a class="sidenav-item-link" href="{{url('/caserequest')}}">
                                        <span class="nav-text">Request Case list</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="sidenav-item-link" href="{{url('/cliend')}}">
                                        <span class="nav-text">Cliend List</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="sidenav-item-link" href="{{url('/lawyerfeedback')}}">
